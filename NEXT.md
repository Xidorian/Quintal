...
- [ ] **Screening gap** — "Setembro 2025 a Junho 2026" (seasonal) slips the `setembro a junho` pattern (year text in between). Loosen the pattern to `setembro.*junho` / `outubro.*(maio|junho)` bounded by a year, or detect month-range spans generally.
