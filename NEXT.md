...
- [ ] **Valuation-outlier robustness** — the unfiltered Idealista pull adds real luxury villas (€8k–30k/mo) and 2 old junk records (a €299k *sale* 'Oportunidade', a €225k *trespasse*) that distort the pool-relative hedonic bands. App-filters hide them from Malia's ≤€1500 view but they still skew every listing's expected price. Fit the model on a trimmed/robust pool (drop implausible or extreme-percentile rents) while still scoring all.
